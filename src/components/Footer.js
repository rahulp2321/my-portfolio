...
const socials = [
  ...
  { label: 'Twitter',  href: 'https://twitter.com/yourusername',       icon: <TwitterIcon /> },
    ...
    <footer className="footer">
      <div className="footer-inner container">
        <div className="footer-top">
          <button className="footer-logo" onClick={scrollTop}>
            <span className="logo-bracket">&lt;</span>YN<span className="logo-bracket">/&gt;</span>
          </button>
        ...
        <div className="footer-bottom">
          <p className="footer-copy">
            © {year} Your Name · Built with React &amp; ❤️
          </p>
